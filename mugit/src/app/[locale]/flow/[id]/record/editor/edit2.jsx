...
//   let resolveRendering; // 여기서 resolveRendering을 정의합니다.

//   const submit = async () => {
//     console.log("클릭했음");
//     let resolveRendering;
//     // 제출 위해 렌더링
...
//     console.log("Starting track rendering...");
...
//     console.log("Individual track URLs:", individualTrackUrls);
...
//     });
//     console.log("변경된 toReleaseFile : ", toReleaseFile);
...
//       console.log(`Emitting rendertrack for track ID: ${trackId}`);
//       ee.emit("rendertrack", trackId, "wav", (data) => {
//         console.log(`Track rendered: ${trackId}`);
...
//         const handleRenderingFinished = (type, data) => {
//           Tone.setContext(toneCtx);
//           if (type === "wav") {
//             const finalTrack = new Blob([data], { type: "audio/wav" });
//             const url = URL.createObjectURL(finalTrack);
//             resolveRendering(url); // resolveRendering 변수가 사용되기 전에 정의되어 있어야 합니다.
//           } else {
//             console.log("Unexpected rendering type:", type);
//           }
//         };

//         ee.on("audiorenderingfinished", handleRenderingFinished);
